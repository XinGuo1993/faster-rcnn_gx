...
class RCNNDetector:
    def __init__(self):
        ...
        self.anchors = 'data/cache/plate_gz_10w_trainval_mix_overlap_09_anchors.pkl'
        self.cfg ='/home/yaoliu/ObjectDetection/plate-detection/faster-rcnn/experiments/cfgs/mix_overlap_09.yml'
        self.net='output/mix_overlap_09/plate_gz_10w_trainval/rpn_zf_mix_overlap_09_plate_gz_10w_trainval.caffemodel'
        #self.anchors='data/cache/plate_gz_10w_trainval_mix_overlap_09_anchors.pkl'
    def predict(self):
        #args = parse_args() 
