...
if __name__ == '__main__':
    ...
    if args.imdb_name:
        ...
        for img_name in img_list:
            print '~' * 20
            im_file = os.path.join(cfg.ROOT_DIR, 'data', img_name)
            print 'Bad case image: `{:s}`'.format(im_file)
            demo(net, im_file, anchors, new_res_dir_name)
    else:
        img_list = ['13.jpg','24.jpg','28.jpg','31.jpg','36.jpg','gz1.jpg','gz2.jpg']
        for img_name in img_list:
            print '~' * 20
            im_file = os.path.join(cfg.ROOT_DIR, 'data', 'error','error','correct_39', img_name)
